...
export default async function Page({ params }: { params: { handle: string, id: string } }) {
	const { handle, id: roleIdStr } = await params
	...
	return (
		<div className="flex flex-col min-h-screen">
			...
			<Content community={community} roleId={roleId} />
		</div>
	)
}
