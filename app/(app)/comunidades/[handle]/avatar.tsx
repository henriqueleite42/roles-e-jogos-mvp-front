...
export function AvatarComponent({ community, member }: Props) {
			...
			<div className="flex justify-between items-end mb-4">
				<div className="relative">
					<Avatar className="h-24 w-24">
						{community.AvatarUrl ? (
							<AvatarImage src={community.AvatarUrl || "/placeholder.svg"} alt={community.Handle} />
						) : (
							<AvatarFallback className="bg-red-100 text-primary text-2xl">
								{community.Handle.substring(0, 2).toUpperCase()}
							</AvatarFallback>
						)}
					</Avatar>
