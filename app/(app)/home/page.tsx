				...
				<div className="grid grid-cols-2 gap-3 max-w-md mx-auto pt-2 md:grid-cols-4 md:max-w-5xl">
					...
					>
						...
						<div className="relative flex aspect-square flex-col items-center justify-center p-4">
							...
							<div className="text-xl font-bold text-yellow-600 text-center">Importar</div>
					...
					<Link
						...
						className="group relative overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
					>
						<div className="absolute inset-0 bg-gradient-to-br from-fuchsia-400/20 to-fuchsia-600/20 opacity-50"></div>
						<div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-fuchsia-500/10"></div>
						<div className="absolute -left-4 -bottom-4 h-16 w-16 rounded-full bg-fuchsia-500/20"></div>

						<div className="relative flex aspect-square flex-col items-center justify-center p-4">
							<div className="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-400 to-fuchsia-600 p-3 shadow-md transition-transform duration-300 group-hover:scale-110">
								<UserRound className="h-8 w-8 text-white" />
							</div>
							<div className="text-xl font-bold text-fuchsia-600 text-center">Parceiros</div>
							<div className="absolute bottom-0 h-1 w-1/2 rounded-full bg-gradient-to-r from-fuchsia-400 to-fuchsia-600 transition-all duration-300 group-hover:w-3/4"></div>
						</div>
					</Link>
				</div>
