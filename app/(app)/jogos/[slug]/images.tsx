...
import { GameData, ResponseGetGallery } from "@/types/api"
...
export const GameImages = ({ game }: Params) => {
	...
	const { data: images, isPending, fetchNextPage } = useInfiniteQuery<ResponseGetGallery>({
		...
		queryFn: async ({ pageParam = null }) => {
			...
			const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/medias/game?${query.toString()}`, {
				credentials: "include"
			})
