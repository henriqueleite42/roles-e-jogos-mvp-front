...
// const addComment = async (locationId: string, content: string, rating?: number): Promise<Comment> => {
// 	// Simulate API delay
...
// 		try {
// 			const newComment = await addComment(location.id, values.content, selectedRating)
// 			setLocation({
// 				...location,
...
// 					Avaliações e Comentários ({location.comments.length})
// 				</CardTitle>
// 			</CardHeader>
...
// 							<p className="text-muted-foreground">Nenhum comentário ainda. Seja o primeiro a avaliar!</p>
// 						</div>
// 					)}
// 				</div>
// 			</CardContent>
